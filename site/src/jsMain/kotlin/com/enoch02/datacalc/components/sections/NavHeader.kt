package com.enoch02.datacalc.components.sections
...
import com.enoch02.datacalc.components.widgets.IconButton
...
fun NavHeader() {
    Row(NavHeaderStyle.toModifier(), verticalAlignment = Alignment.CenterVertically) {
        Link("https://github.com/Enoch02/") {
            // Block display overrides inline display of the <img> tag, so it calculates centering better
            Image("/dd.jpg", "Double D", Modifier.height(2.cssRem).display(DisplayStyle.Block))
        }
