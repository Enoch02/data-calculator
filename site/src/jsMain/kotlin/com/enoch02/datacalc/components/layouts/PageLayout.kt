package com.enoch02.datacalc.components.layouts
...
import com.enoch02.datacalc.components.sections.Footer
import com.enoch02.datacalc.components.sections.NavHeader
...
fun PageLayout(title: String, content: @Composable ColumnScope.() -> Unit) {
    LaunchedEffect(title) {
        document.title = "Basic Data Calculator - $title"
    }
